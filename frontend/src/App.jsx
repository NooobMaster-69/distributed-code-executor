...
const DEFAULT_CODE = {
  ...
  node: '// Write your JavaScript code here\nconsole.log("Hello, World!");\n',
  bash: '#!/bin/bash\necho "Hello, World!"\n',
  powershell: '# Write your PowerShell code here\nWrite-Output "Hello, World!"\n',
};
        ...
        <div className="header-left">
          <div className="logo">
            <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
              <rect x="2" y="2" width="24" height="24" rx="6" stroke="url(#g1)" strokeWidth="2.5" />
              <path d="M9 10l4 4-4 4" stroke="url(#g1)" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
              <line x1="15" y1="18" x2="20" y2="18" stroke="url(#g1)" strokeWidth="2.2" strokeLinecap="round" />
              <defs>
